...
RUN echo "(cd /home/ciphrtxt/msgstore && python3 ./app.py --rpcuser=\$COINSVC_USERNAME --rpcpass=\$COINSVC_PASSWORD --coinhost=\$COINSVC_HOST --coinport=\$COINSVC_RPCPORT --exthost=\$EXTHOSTNAME --nakpriv=\$NAKPRIV)" >> /home/ciphrtxt/run.sh
